...
export class initDatabase1606470249552 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE TABLE IF NOT EXISTS `users` (`uuid` varchar(255) NOT NULL, `version` varchar(255) NOT NULL, `encrypted_password` varchar(255) NOT NULL, PRIMARY KEY (`uuid`)) ENGINE=InnoDB')
    }
